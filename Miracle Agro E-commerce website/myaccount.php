...
<title>Untitled Document</title>
    ...
    <style>
  body{
  background:url(images/bgmyACC.jpg);
  margin: 0;
  padding: 0;
  ...
  <tbody>
    <tr>
      ...
      <div class="dashbord dashbord-green">
        ...
        <div class="detail-section"> <a href="AddProduct.php">Add product </a> </div>
      </div>
      <div class="dashbord dashbord-blue">
        ...
        <div class="detail-section"> <a href="ViewMyProducts.php">View product</a> </div>
      </div>
      <div class="dashbord dashbord-skyblue">
        ...
        <div class="detail-section"><a href="EditProducts.php">Publish product</a> </div>
      </div>
      <div class="dashbord dashbord-red">
        ...
        <div class="detail-section"> <a href="EditProduct.php">Edit product </a> </div>
      </div>
      <div class="dashbord dashbord-orange">
        ...
        <div class="detail-section"> <a href="ViewProducts.php">View All products</a> </div>
      </div>
    </div></td>
    </tr>
  </tbody>
