...
<p>
  <input type="text" name="txtTitle" placeholder="Product Name *" value="<?php echo $row["pname"]; ?>" >
  ...
  Category   <select  name="lstType">
    <option value="glass" <?php if ($row["category"]=="glass"){echo "selected"; }?> >Glass</option>
    <option value="metal" <?php if ($row["category"]=="metal"){echo "selected"; }?> >Metal</option>
    <option value="cardboard <?php if ($row["category"]=="cardboard"){echo "selected"; }?>">Cardboard </option>
     <option value="paper" <?php if ($row["category"]=="paper"){echo "selected"; }?>>Paper</option>
     <option value="plastic" <?php if ($row["category"]=="plastic"){echo "selected"; }?>>Plastic</option>
